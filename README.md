...
## 🖥 Uso del Web Scrapper (flujo legacy interactivo)

Para usar el sistema interactivo completo con base de datos SQLite (implementación antigua pero funcional):
```powershell
python main.py
```

Para verificar los datos insertados en SQLite:
```powershell
python view_data.py
```